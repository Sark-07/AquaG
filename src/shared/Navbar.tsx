...
const Navbar = (props: Props) => {
  ...
  return (
   <nav className='w-full h-fit flex items-center justify-center absolute top-10'>
     <div className='w-4/6 px-8 py-2 flex items-center justify-between mx-auto  z-[9999] bg-white/10 shadow-[0_8px_32px_0_rgba(31,38,135,0.15)] backdrop-blur-0 rounded-xl'>
